...
public:
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actAbout->setText(QCoreApplication::translate("QWMainWind", "user", nullptr));
#if QT_CONFIG(tooltip)
        actAbout->setToolTip(QCoreApplication::translate("QWMainWind", "\346\230\276\347\244\272\344\270\252\344\272\272\344\277\241\346\201\257", nullptr));
#endif // QT_CONFIG(tooltip)
